...
- [done ]  A navigation bar with `About`, `Projects`, and `Contact` that link to the corresponding pages
...
- [done ]  A `My Projects` button that links to the projects page
- [done ]  A `Contact Me` button that links to the contact page
- [done ]  Links to any social media profiles (Instagram, linkedIn, Twitter) into the footer section of your home page
